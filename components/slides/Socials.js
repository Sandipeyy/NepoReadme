...
export default function Socials({ back }) {
  ...
  function onNext() {
    socials = "";
    if (document.getElementById("bluesky").value != "") {
      socials =
        socials +
        `[![Bluesky](https://img.shields.io/badge/bluesky-0285FF?style=for-the-badge&logo=bluesky&logoColor=%23FFFFFF)](https://bsky.app/profile/${
          document.getElementById("bluesky").value
        }) `;
    }
      ...
      {isVisible ? (
        ...
        <div className="flex flex-col mt-10 items-center fade-on-appear">
          ...
          <div className="w-full md:w-8/12 flex justify-between flex-wrap my-10">
            <TextInputWithIcon
              id="bluesky"
              placeholder="Bluesky Username (without @)"
            >
              <svg
                role="img"
                viewBox="0 0 24 24"
            ...
            <TextInputWithIcon
              id="mastodon"
              placeholder="Mastodon Username (without @)"
              viewBox="0 0 24 24"
            >
